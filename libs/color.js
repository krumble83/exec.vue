...
function Color(...inputs) {
    this.init(...inputs)
}


  Color.prototype.init = function(a = 0, b = 0, c = 0, d = 0, space = 'rgb') {
  ...
  */
  ...
  Color.prototype.darker = function(amount){
	  this._a = parseInt(this._a * (1 - amount));
	  this._b = parseInt(this._b * (1 - amount));
	  this._c = parseInt(this._c * (1 - amount));
	  return this;
  }
  ...
  */
  ...
  Color.random = function(mode = 'vibrant', t, u) {
